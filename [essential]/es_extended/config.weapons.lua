Config.Weapons = {
	...
	{
		name = 'WEAPON_DUONGVAT',
		label = _U('weapon_duongvat'),
		components = {}
	},
	
	{
		name = 'WEAPON_M8A7',
		label = _U('weapon_m8a7'),
		components = {}
	},
	...
	{
		name = 'WEAPON_LUOIHAI',
		label = _U('weapon_luoihai'),
		components = {}
	},
	
	{
		name = 'WEAPON_MAGIKSWORD',
		label = _U('weapon_magiksword'),
		components = {}
	},
	
	{
		name = 'WEAPON_HALBERD',
		label = _U('weapon_halberd'),
		components = {}
	},
	
	{
		name = 'WEAPON_ROSESWORD',
		label = _U('weapon_rosesword'),
		components = {}
	},
	...
	
	{
		...
		components = {
			...
			{ name = 'clip_armorpiercing', label = _U('component_clip_armorpiercing'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CLIP_ARMORPIERCING') }, 
			{ name = 'clip_fmj', label = _U('component_clip_fmj'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CLIP_FMJ') }, 
			{ name = 'clip_explosive', label = _U('component_clip_explosive'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CLIP_EXPLOSIVE') }, 
			{ name = 'scope_large_mk2', label = _U('component_scope_large_mk2'), hash = GetHashKey('COMPONENT_AT_SCOPE_LARGE_MK2') }, 
			{ name = 'scope_advanced', label = _U('component_scope_advanced'), hash = GetHashKey('COMPONENT_AT_SCOPE_MAX') },
			{ name = 'scope_nv', label = _U('scope_nv'), hash = GetHashKey('COMPONENT_AT_SCOPE_NV') }, 
			{ name = 'scope_thermal', label = _U('component_scope_thermal'), hash = GetHashKey('COMPONENT_AT_SCOPE_THERMAL') }, 
			{ name = 'sr_supp_03', label = _U('component_sr_supp_03'), hash = GetHashKey('COMPONENT_AT_SR_SUPP_03') }, 
			{ name = 'muzzzle_08', label = _U('component_muzzzle_08'), hash = GetHashKey('COMPONENT_AT_MUZZLE_08') }, 
			{ name = 'muzzzle_09', label = _U('component_muzzzle_09'), hash = GetHashKey('COMPONENT_AT_MUZZLE_09') }, 
			{ name = 'sr_barrel_01', label = _U('component_sr_barrel_01'), hash = GetHashKey('COMPONENT_AT_SR_BARREL_01') },  
			{ name = 'sr_barrel_02', label = _U('component_sr_barrel_02'), hash = GetHashKey('COMPONENT_AT_SR_BARREL_02') }, 
			{ name = 'camo', label = _U('component_camo'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO') }, 
			{ name = 'camo2', label = _U('component_camo2'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO_02') }, 
			{ name = 'camo3', label = _U('component_camo3'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO_03') }, 
			{ name = 'camo4', label = _U('component_camo4'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO_04') },  
			{ name = 'camo5', label = _U('component_camo5'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO_05') }, 
			{ name = 'camo6', label = _U('component_camo6'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO_06') }, 
			{ name = 'camo7', label = _U('component_camo7'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO_07') },  
			{ name = 'camo8', label = _U('component_camo8'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO_08') }, 
			{ name = 'camo9', label = _U('component_camo9'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO_09') }, 
			{ name = 'camo10', label = _U('component_camo10'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO_10') },  
			{ name = 'camo11', label = _U('component_camo11'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CAMO_IND_01') }
		}
	},
