...
Config.Garages = {
	...
	Garage_mirrorpark = {	
	 ...
	 --[[Garage_Tournoi = {	
		...
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Nhan ~INPUT_PICKUP~ de mo garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x = -1029.7,y = -2991.7,z = 13.1 },
			Heading = 264.63,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "Nhan ~INPUT_PICKUP~ de hien thi danh sach phuong tien",
			Functionmenu = ListVehiclesMenu,
		},
		DeletePoint = {
			Pos = {x = -1073.8,y = -2946.2,z = 13.9 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "Nhan ~INPUT_PICKUP~ de cat phuong tien vao garage",
			Functionmenu = StockVehicleMenu,
		}, 	
	},	
