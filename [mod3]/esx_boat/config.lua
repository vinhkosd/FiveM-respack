...
Config.Vehicles = {
	...
	{model = 'seashark3', label = 'Seashark (Dark Blue)', price = 350000},
	{model = 'suntrap', label = 'Suntrap', price = 380000},
	{model = 'jetmax', label = 'Jetmax', price = 390000},
	{model = 'tropic2', label = 'Tropic', price = 400000},
	{model = 'dinghy2', label = 'Dinghy (Black)', price = 999999999},
	{model = 'dinghy', label = 'Dinghy 2 (Random Color)', price = 999999999},
	{model = 'speeder', label = 'Speeder', price = 999999999},
	{model = 'squalo', label = 'Squalo (Random Color)', price = 999999999},
	{model = 'toro', label = 'Toro', price = 999999999},
	{model = 'submersible', label = 'Submersible', price = 999999999},
	{model = 'sr650fly', label = 'Searay', price = 999999999}
}