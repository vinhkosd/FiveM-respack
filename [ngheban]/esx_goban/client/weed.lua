...
function ProcessGo()
	...
	TriggerServerEvent('chebiengoban')
	...
	while timeLeft > 0 do
		...
		if GetDistanceBetweenCoords(GetEntityCoords(playerPed), Config.CircleZones.WeedProcessing.coords, false) > 4 then
			...
			TriggerServerEvent('esx_goban:cancelProcessing')
			break
		end
	end
	...
	while true do
		...
		if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
					...
					local 		PlayerData = ESX.GetPlayerData()
						...
						ESX.TriggerServerCallback('cothechat', function(canPickUp)
...
-- cây gỗ: prop_joshua_tree_01b
		ESX.Game.SpawnLocalObject('prop_joshua_tree_01b', weedCoords, function(obj)
