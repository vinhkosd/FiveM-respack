Config = {}
	...
	Config.FishPrice = {a = 300, b = 350} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 10000, b = 20000} --Will get dirty money
	Config.SharkPrice = {a = 30000, b = 40000} --Will get dirty money
