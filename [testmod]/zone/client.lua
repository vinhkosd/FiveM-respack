...
local zones = {
	{ ['x'] = 307.7	, ['y'] = -1433.4, ['z'] = 29.2},
	{ ['x'] = 425.1, ['y'] = -979.5, ['z'] = 29.2 },
	{ ['x'] = - 265.0, ['y'] = - 963.6, ['z'] = 29.2},
	{ ['x'] = 1792.781, ['y'] = 2482.958, ['z'] = -122.6956},
	{ ['x'] = 1009.074, ['y'] = -3100.502, ['z'] = -39.0},
}
	...
	while true do
		...
		if dist <= 50.0 then  ------------------------------------------------------------------------------ Here you can change the RADIUS of the Safe Zone. Remember, whatever you put here will DOUBLE because 
			if not notifIn then																			  -- it is a sphere. So 50 will actually result in a diameter of 100. I assume it is meters. No clue to be honest.
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>Bạn đang ở vùng an toàn</b>",
					type = "success",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
			...
			if not notifOut then
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>Bạn không còn trong vùng an toàn</b>",
					type = "error",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
		...
		DisableControlAction(0, 140, true)
			if IsDisabledControlJustPressed(2, 37) then --if Tab is pressed, send error message
				...
				TriggerEvent("pNotify:SendNotification",{
					text = "<b style='color:#1E90FF'>Bạn không thể mua vũ khí trong vòng an toàn</b>",
					type = "error",
					timeout = (3000),
					layout = "bottomcenter",
					queue = "global"
