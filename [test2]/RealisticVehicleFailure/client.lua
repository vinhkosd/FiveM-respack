	...
	if isPedDrivingAVehicle() then
		...
		if IsNearMechanic() then
			if GetIsVehicleEngineRunning(vehicle) then
				notification("~g~Dong co phai duoc tat de sua chua")
				return
			else
				...
				if PlayerData.job.name == 'mecano' then
					...
					notification("~g~Ban da sua xe!")
					return			
				else
					if mechNumb == 1 then
						notification("~g~Nhan vien dang nhin vao xe cua ban")
						Citizen.Wait(11000)
						notification("~g~Nhan vien dang lam viec tren xe cua ban")
						Citizen.Wait(11000)
						if GetIsVehicleEngineRunning(vehicle) then
							notification("~g~Dong co phai tat de sua chua")
							return
						else
							SetVehicleUndriveable(vehicle,false)
							SetVehicleFixed(vehicle)
							...
							if cfg.chargeForRepairs then
								...
								notification("~g~Nhan vien da sua xe cho $" .. repairCost .. "!")
								return
							else
								notification("~g~Nhan vien sua xe!")
								return
							end
						end
					elseif mechNumb == 2 then
						notification("~g~Nhan vien dang nhin vao xe cua ban")
						Citizen.Wait(11000)
						notification("~g~Nhan vien co ve boi roi")
						Citizen.Wait(11000)
						notification("~g~Nhan vien bat dau danh moi thu bang bua")
						Citizen.Wait(11000)
						notification("~g~Nhan vien di tim su giup do")
						Citizen.Wait(11000)
						notification("~g~Nhan vien quan ly tro lai va bat dau lam viec tren xe cua ban")
						Citizen.Wait(11000)	
						notification("~g~Nguoi quan ly cung dang dap moi thu bang bua")
						Citizen.Wait(11000)	
						if GetIsVehicleEngineRunning(vehicle) then
							notification("~g~Dong co phai tat de sua chua")
							return
							...
							if cfg.chargeForRepairs then
								TriggerServerEvent('rvFailure:takemoney', repairCost)
								notification("~g~Nguoi quan ly da sua xe cho ban $" .. repairCost .. "!")
								return
							else
								notification("~g~Quan ly da sua xe cua ban!")
								return
							end
						end
					elseif mechNumb == 3 then
						notification("~g~Nhan vien tho may dang nhin vao xe cua ban")
						Citizen.Wait(11000)
						notification("~g~Nhan vien het len de Dave nhin vao no")
						Citizen.Wait(11000)
						notification("~g~Nhan vien nhin no")
						Citizen.Wait(11000)
						notification("~g~Nhan vien dang lam viec tren xe cua ban")
						Citizen.Wait(11000)	
						if GetIsVehicleEngineRunning(vehicle) then	
