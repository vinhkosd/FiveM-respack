	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		...
		if data.current.value == 'citizen_interaction' then
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				local nhanpham = math.random(1, 100)
				if closestPlayer == -1 or closestDistance > 1.0 then
					...
					if data.current.value == 'revive' then
						if not IsPedInAnyVehicle(PlayerPedId(), false) then
							...
							ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
								if quantity > 0 then
									...
									if IsPedDeadOrDying(closestPlayerPed, 1) then
										...
										exports['progressBars']:startUI(15000, "Đang cứu")
										...
										if playerdata.job.grade_name == 'boss' then
											TriggerServerEvent('esx_ambulancejob:removeItem', 'dungcuyte')
											TriggerServerEvent('esx_ambulancejob:revive', GetPlayerServerId(closestPlayer))
										elseif playerdata.job.grade_name == 'chief_doctor' and nhanpham >= 1 then
											TriggerServerEvent('esx_ambulancejob:removeItem', 'dungcuyte')
											TriggerServerEvent('esx_ambulancejob:revive', GetPlayerServerId(closestPlayer))
										elseif playerdata.job.grade_name == 'doctor' and nhanpham >= 1 then
											TriggerServerEvent('esx_ambulancejob:removeItem', 'dungcuyte')
											TriggerServerEvent('esx_ambulancejob:revive', GetPlayerServerId(closestPlayer))
										elseif playerdata.job.grade_name == 'ambulance' and nhanpham >= 1 then
											TriggerServerEvent('esx_ambulancejob:removeItem', 'dungcuyte')
											TriggerServerEvent('esx_ambulancejob:revive', GetPlayerServerId(closestPlayer))
										else
											ESX.ShowNotification('Ca này hơi khó, gọi cấp trên tới giải quyết')
										end
										TriggerEvent("XNL_NET:AddPlayerXP", math.random(30, 50))
										TriggerServerEvent("AddXp", math.random(30, 50))
										-- Show revive award?
							...
							ESX.ShowNotification('Bạn không thể cứu người khi đang ở trên phương tiện')
						end
...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		align    = 'top-left',
		elements = {
			{label = _U('pharmacy_take', _U('medikit')), value = 'dungcuyte'},
