...
Citizen.CreateThread(function()
    ...
    for locationIndex = 1, #Config.SellBottleLocations do
        ...
        AddTextComponentString("Chỗ Bán Chai Rỗng")
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if DoesEntityExist(entity) and entityDst <= 1.5 then
            ...
            ESX.Game.Utils.DrawText3D(binCoords + vector3(0.0, 0.0, 0.5), "[~g~E~s~] tim kiem rac", 0.4)
            ...
            if IsControlJustReleased(0, 38) then
                if not cachedBins[entity] then
                    ...
                    ESX.ShowNotification("ban da tim thung nay!")
                end
            end
        end
