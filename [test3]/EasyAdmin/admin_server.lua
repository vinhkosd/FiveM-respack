...
Citizen.CreateThread(function()
	...
	AddEventHandler('EasyAdmin:amiadmin', function()
		...
		TriggerClientEvent("EasyAdmin:SetSetting", source, "button",GetConvarInt("ea_MenuButton", 344) )
	...
	AddEventHandler('EasyAdmin:TakeScreenshot', function(playerId)
		...
		if DoesPlayerHavePermission(source,"easyadmin.screenshot") then
			thistemporaryevent = AddEventHandler("EasyAdmin:TookScreenshot", function(resultURL)
				...
				SendWebhookMessage('https://discordapp.com/api/webhooks/676519821063618560/uf7y_8P20clt-DPkW_AnCwj1HJ6ZO9lCC0y6sPQgSyG8GJTTkW8KhDezvQLLpkd5q6PC', string.format(GetLocalisedText("admintookscreenshot"), getName(src), getName(playerId), resultURL))
				scrinprogress = false
