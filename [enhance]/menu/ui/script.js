$(document).ready(function(){
  ...
  $('.openCoffre').on('click', function(e){
    ...
    $(this).find('.text').text($(this).find('.text').text() == 'Mở cốp' ? 'Đóng cốp' : 'Mở cốp');
  });
  ...
  $('.openCapot').on('click', function(e){
    ...
    $(this).find('.text').text($(this).find('.text').text() == 'Mở mui xe' ? 'Đóng mui xe' : 'Mở mui xe');
  });
  ...
  $('.lock').on('click', function(e){
    ...
    $(this).find('.text').text($(this).find('.text').text() == 'Khoá xe' ? 'Mở khoá xe' : 'Khoá xe');
  });
  ...
  $('.smoke').on('click', function(e){
    e.preventDefault();
    $.post('http://menu/smoke', JSON.stringify({
      id: idEnt
    }));
  });
  $('.kiss').on('click', function(e){
    e.preventDefault();
    $.post('http://menu/kiss', JSON.stringify({
      id: idEnt
    }));
  });
  $('.drink').on('click', function(e){
    e.preventDefault();
    $.post('http://menu/drink', JSON.stringify({
      id: idEnt
    }));
  });
