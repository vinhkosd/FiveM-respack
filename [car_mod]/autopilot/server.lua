...
RegisterCommand("tudonglai", function(source, args, raw)
    local src = source
    TriggerClientEvent("autopilot:start", src)
end)

RegisterCommand("stopautopilot", function(source, args, raw)
    local src = source
    TriggerClientEvent("autopilot:stop", src)
end)

RegisterCommand("huytudong", function(source, args, raw)
    local src = source
    TriggerClientEvent("autopilot:stop", src)
end)
