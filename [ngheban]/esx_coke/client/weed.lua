...
function ProcessCoke()
	...
	TriggerServerEvent('chebiencoke')
	...
	while true do
		...
		if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
					...
					local 		PlayerData = ESX.GetPlayerData()
						...
						ESX.TriggerServerCallback('Cothehai', function(canPickUp)
...
-- lá cocain: prop_fib_plant_02
		ESX.Game.SpawnLocalObject('prop_agave_02', weedCoords, function(obj)
