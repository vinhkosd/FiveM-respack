...
TriggerEvent('es:addGroupCommand', 'setjob2', 'jobmaster', function(source, args, user)
	...
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SYSTEM', 'Insufficient Permissions.' } })
end, {help = 'setjob2', params = {{name = "id", help = _U('id_param')}, {name = "job", help = _U('setjob_param2')}, {name = "grade_id", help = _U('setjob_param3')}}})
...
TriggerEvent('es:addGroupCommand', 'settiencailontaonay', 'admin', function(source, args, user)
