...
AddEventHandler('esx_ambulancejob:revive', function(target)
	...
	if xPlayer.job.name == 'ambulance' then
		...
		xTarget.removeMoney(Config.ReviveReward)
...
ESX.RegisterServerCallback('esx_ambulance:getLoadout', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	cb(xPlayer.loadout)
end)
...
AddEventHandler('esx_ambulancejob:giveItem', function(itemName)
	...
	if xPlayer.job.name ~= 'ambulance' then
		...
		return
	elseif (itemName ~= 'dungcuyte' and itemName ~= 'bandage') then
		print(('esx_ambulancejob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
		return
	end
