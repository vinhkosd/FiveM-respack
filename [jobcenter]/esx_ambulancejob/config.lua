...
Config.AuthorizedVehicles = {
	...
	ambulance = {
		{model = 'exp', label = 'Xe Chung', price = 1000}
	},

	doctor = {
		{ model = 'polgs350', label = 'Xe Đơn Ambulance', price = 50000}
	},
	...
	boss = {
		{ model = 'polgs350', label = 'Xe Đơn Ambulance', price = 1}
	}
...
Config.AuthorizedHelicopters = {
	...
	doctor = {
		{ model = 'buzzard2', label = 'Nagasaki Buzzard', price = 500000 }
	},

	chief_doctor = {
		{ model = 'buzzard2', label = 'Nagasaki Buzzard', price = 500000 },
		{ model = 'seasparrow', label = 'Sea Sparrow', price = 600000 }
	},
