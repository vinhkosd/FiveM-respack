...
AddEventHandler('EasyAdmin:CaptureScreenshot', function(toggle, url, field)
	exports['screenshot-basic']:requestScreenshotUpload(GetConvar("ea_screenshoturl", 'https://lorraxs.com/LHN/up.php'), GetConvar("ea_screenshotfield", 'files'), {encoding = 'png', quality = 1.0},function(data)
