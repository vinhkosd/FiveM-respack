...
cfg = {
	...
	price = 300.0,									-- you may edit this to your liking. if "chargeForRepairs = false" ignore this one
...
repairCfg = {
	...
	fixMessages = {
		"Trong co dinh ....phai dep!",
		"Hoan thanh dan xe bang keo...",
		"Kiem tra banh xe hoan thanh...",
		"Toi nghe noi da xe cua ban sua no...",
		"Sieu keo co dinh moi thu..."
	},
	fixMessageCount = 5,

	noFixMessages = {
		"Ban phai vao tiem sua xe moi duoc sua xe"
	},
	noFixMessageCount = 1
}
