...
local function HarvestCoke(source)
	...
	TriggerClientEvent("progbar:startUi", source, Config.TimeToFarm, "Đang thu hoạch")
...
local function TransformCoke(source)
	...
	TriggerClientEvent("progbar:startUi", source, Config.TimeToFarm, "Đang chế biến")
...
local function SellCoke(source)
	...
	TriggerClientEvent("progbar:startUi", source, Config.TimeToFarm, "Đang bán")
