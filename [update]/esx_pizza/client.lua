...
[14] ={name ="Old School" ,x= -1004.788, y=-1154.824,z = 1.64603},
[15] ={name ="Old School 1" ,x= -1113.937, y=-1193.136,z = 1.827304},
[16] ={name ="Old School 2" ,x= -1075.903, y=-1026.452,z = 4.031562},
[17] ={name ="Old School 3" ,x= -1056.485, y=-1001.234,z = 1.639098},
[18] ={name ="Old School 4" ,x= -1090.886, y=-926.188,z = 2.630009},
[19] ={name ="Old School 5" ,x= -1075.903, y=-1026.452,z = 4.031562},
[20] ={name ="Old School 6" ,x= -1181.652, y=-988.6455,z = 1.634243},
[21] ={name ="Old School 7" ,x= -1151.11, y=-990.905,z = 1.638789},
[22] ={name ="Old School 8" ,x= -1022.788, y=-896.3149,z = 4.908271},
[23] ={name ="Old School 9" ,x= -1060.738, y=-826.829,z = 18.69866},
[24] ={name ="Old School 10" ,x= -968.6487, y=-1329.453,z = 5.144861},
[25] ={name ="Old School 11" ,x= -1185.5, y=-1386.238,z = 4.112149},
[26] ={name ="Old School 12" ,x= -1132.848, y=-1456.029,z = 4.372081},
[27] ={name ="Old School 13" ,x= -1125.602, y=-1544.203,z = 5.391256},
[28] ={name ="Old School 14" ,x= -1084.74, y=-1558.709,z = 4.10145},
[29] ={name ="Old School 15" ,x= -1098.367, y=-1679.272,z = 3.853804},
[30] ={name ="Old School 16" ,x= -1155.863, y=-1574.202,z = 8.344403},
[31] ={name ="Old School 17" ,x= -1122.675, y=-1557.524,z = 5.277201},
[32] ={name ="Old School 18" ,x= -1108.679, y=-1527.393,z = 6.265457},
[33] ={name ="Old School 19" ,x= -1273.549, y=-1382.664,z = 3.81341},
[34] ={name ="Old School 20" ,x= -1342.454, y=-1234.849,z = 5.420023},
[35] ={name ="Old School 21" ,x= -1351.21, y=-1128.669,z = 3.626104},
[36] ={name ="Old School 22" ,x= -1343.232, y=-1043.639,z = 7.303696},
[37] ={name ="Old School 23" ,x= -729.2556, y=-880.1547,z = 22.22747},
[38] ={name ="Old School 24" ,x= -831.3006, y=-864.8558,z = 20.22383},
[39] ={name ="Old School 25" ,x= -810.4093, y=-978.4364,z = 13.74061},
[40] ={name ="Old School 26" ,x= -683.8874, y=-876.8568,z = 24.02004},
[41] ={name ="Old School 27" ,x= -1031.316, y=-903.0217,z = 3.692086},
[42] ={name ="Old School 28" ,x= -1262.703, y=-1123.342,z = 7.092357},
[43] ={name ="Old School 29" ,x= -1225.079, y=-1208.524,z = 7.619214},
[44] ={name ="Old School 30" ,x= -1207.095, y=-1263.851,z = 6.378308},
[45] ={name ="Old School 31" ,x= -1086.787, y=-1278.122,z = 5.09411},
[46] ={name ="Old School 32" ,x= -886.1298, y=-1232.698,z = 5.006698},
[47] ={name ="Old School 33" ,x= -753.5927, y=-1512.016,z = 4.370816},
[48] ={name ="Old School 34" ,x= -696.3545, y=-1386.89,z = 4.846177}
}

local blips = {
  {title="Giao Pizza", colour=51, id=103, x = -1285.73, y = -1387.15, z = 3.44}, --Configuration du point sur la carte
}
  ...
  while true do
    ...
    if isInJobPizz == false then
      ...
      if GetDistanceBetweenCoords(pizzeria.x, pizzeria.y, pizzeria.z, GetEntityCoords(GetPlayerPed(-1),true)) < 1.5 then
        HelpText("Nhấn [E] để bắt đầu phân phối ~ r ~ pizza",0,1,0.5,0.8,0.6,255,255,255,255)
    ...
    if isToHouse == true then
      ...
      if GetDistanceBetweenCoords(px,py,pz, GetEntityCoords(GetPlayerPed(-1),true)) < 3 then
        HelpText("Nhấn [E] để giao bánh pizza",0,1,0.5,0.8,0.6,255,255,255,255)
    ...
    if isToPizzaria == true then
      ...
      if GetDistanceBetweenCoords(pizzeria.x,pizzeria.y,pizzeria.z, GetEntityCoords(GetPlayerPed(-1),true)) < 3 and afaitunepizzamin == true then
        HelpText("Nhấn [E] để lấy pizza",0,1,0.5,0.8,0.6,255,255,255,255)
  ...
  while true do
    ...
    if isInJobPizz == true then
      ...
      if GetDistanceBetweenCoords(pizzeriafin.x, pizzeriafin.y, pizzeriafin.z, GetEntityCoords(GetPlayerPed(-1),true)) < 1.5 then
        HelpText("Nhấn [E] để ngừng phân phối ~ r ~ pizza",0,1,0.5,0.8,0.6,255,255,255,255)
