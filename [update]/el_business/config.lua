...
Config.display = {
    ...
    {offset = 0.0, text = "{description}", scale = 0.7},
    {offset = -0.1, text = "~b~Chủ sở hữu: ~r~{owner_name} ~b~Giá trị: ~g~${price} ~s~(~r~{taxrate}% Thuế~s~)", scale = 1},
    {offset = -0.21, text = "~b~Lợi nhuận: ~g~${earnings}/giờ", scale = 1}
}
