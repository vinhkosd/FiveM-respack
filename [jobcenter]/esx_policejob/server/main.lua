...
AddEventHandler('esx_policejob:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	elseif itemType == 'item_account' then
		local targetAccountMoney = targetXPlayer.getAccount(itemName)
		print(json.encode(targetAccountMoney))
		if amount <= targetAccountMoney.money then
			targetXPlayer.removeAccountMoney(itemName, amount)
			sourceXPlayer.addAccountMoney   (itemName, amount)
		else
			TriggerClientEvent('esx:showNotification', _source, 'Không thể thực hiện')
		end
...
ESX.RegisterServerCallback('2785e659-a064-451c-b65d-84d47bdc9086', function(source, cb, item)
...
RegisterServerEvent('28f6ef64-ba47-47e5-9903-286df481fdb1')
AddEventHandler('28f6ef64-ba47-47e5-9903-286df481fdb1', function(item)
	local _source = source
	...
	if item == 'bandage' then
		TriggerClientEvent('bcd4a96b-6aee-405c-b005-b558db482478', _source, _U('used_bandage'))
	elseif item == 'medikit' then
		TriggerClientEvent('bcd4a96b-6aee-405c-b005-b558db482478', _source, _U('used_medikit'))
	end
end)

RegisterServerEvent('fd305b6b-28cb-4541-8830-cb0174031c50')
AddEventHandler('fd305b6b-28cb-4541-8830-cb0174031c50', function(target)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('esx_policejob:doesHandCuff')
AddEventHandler('esx_policejob:doesHandCuff', function(target)
	TriggerClientEvent('esx_policejob:doesHandCuff', target, source)
end)

RegisterServerEvent('esx_policejob:returnHandcuff')
AddEventHandler('esx_policejob:returnHandcuff', function(result, by)
	--local _source = source
	if result == true then
		...
		TriggerClientEvent('esx_ruski_areszt:aresztowany', targetPlayer.source, by)
		TriggerClientEvent('esx_ruski_areszt:aresztuj', by)
		Citizen.Wait(5100)
		TriggerClientEvent('esx_policejob:handcuff', targetPlayer.source)
	end
end)
...
RegisterServerEvent('esx_policejob:getItemAmount', function(source, cb, item)
	local xPlayer = ESX.GetPlayerFromId(source)
	local quantity = xPlayer.getInventoryItem(item).count
	cb(quantity)
end)