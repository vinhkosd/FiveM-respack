Config = {}
Config.Blip			= {sprite= 290, color = 63}
Config.MecanoBlip	= {sprite= 290, color = 46}
Config.airportBlip	= {sprite= 290, color = 46}
Config.Price		= 3000
...
Config.Garages = {
	Garage_Centre = {	
		...
		Name = '<FONT FACE = "arial font">Garage Gửi Xe',
		HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để mở garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x=229.700, y= -800.1149, z= 30.5722},
			Heading = 157.84,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để hiển thị danh sách phương tiện",
			Functionmenu = ListVehiclesMenu,
		},
		DeletePoint = {
			Pos = {x=215.124, y=-791.377, z=30.646},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để cất phương tiện vào garage",
			Functionmenu = StockVehicleMenu,
		}, 	
	},
	Garage_Giamxe = {	
		Pos = {x=828.0377, y=-1363.936, z=26.12222},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = '<FONT FACE = "arial font">Garage Gửi Xe',
		HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để mở garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x=835.0641, y= -1364.68, z= 26.12944},
			Heading = 157.84,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để hiển thị danh sách phương tiện",
			Functionmenu = ListVehiclesMenu,
		...
		DeletePoint = {
			Pos = {x=822.6393, y=-1365.415, z=26.13055},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để cất phương tiện vào garage",
			Functionmenu = StockVehicleMenu,
		}, 	
	...
	Garage_nhatu = {	
		Pos = {x= 1876.444,y= 2580.85,z= 45.67205},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = '<FONT FACE = "arial font">Garage Gửi Xe',
		HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để mở garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x= 1877.071,y= 2587.656,z= 45.67205},
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để hiển thị danh sách phương tiện",
			Functionmenu = ListVehiclesMenu,
		...
		DeletePoint = {
			Pos = {x = 1877.024,y = 2616.098,z = 45.67205}, 
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để cất phương tiện vào garage",
			Functionmenu = StockVehicleMenu,
		},
	...
	Garage_airport = {	
		Pos = {x= -1240.000,y= -3350.000,z= 14.000},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = '<FONT FACE = "arial font">Garage Gửi Xe',
		HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để mở garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x= -1251.000,y= -3343.000,z= 14.000},
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để hiển thị danh sách phương tiện",
			Functionmenu = ListVehiclesMenu,
		...
		DeletePoint = {
			Pos = {x = -1634.000,y = -3118.000,z = 14.000}, 
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để cất phương tiện vào garage",
			Functionmenu = StockVehicleMenu,
		},
	...
	Garage_nhatongthong = {	
		Pos = {x = -596.57635498047, y = 4427.7241210938, z = 24.492744445801},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = '<FONT FACE = "arial font">Garage Gửi Xe',
		HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để mở garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x = -589.14459228516, y = 4432.6909179688, z = 24.492744445801 },
			Heading = 195.24668884277,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để hiển thị danh sách phương tiện",
			Functionmenu = ListVehiclesMenu,
		},
		DeletePoint = {
			Pos = {x = -596.93072509766, y = 4434.3959960938, z = 24.485160827637 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhấn [E] để cất phương tiện vào garage",
			Functionmenu = StockVehicleMenu,
		}, 	
	 ...
	 --[[Garage_Tournoi = {	
		Pos = {x = -1025.4,y = -2952.3,z = 13.9 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "<FONT FACE = 'arial font'>Nhan ~INPUT_PICKUP~ de mo garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x = -1029.7,y = -2991.7,z = 13.1 },
			Heading = 264.63,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhan ~INPUT_PICKUP~ de hien thi danh sach phuong tien",
			Functionmenu = ListVehiclesMenu,
		},
		DeletePoint = {
			Pos = {x = -1073.8,y = -2946.2,z = 13.9 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = "<FONT FACE = 'arial font'>Nhan ~INPUT_PICKUP~ de cat phuong tien vao garage",
			Functionmenu = StockVehicleMenu,
		}, 	
	},	
