function CreateExtendedPlayer(player, accounts, inventory, job, job2, loadout, name, lastPosition)
	...
	self.addMoney = function(money)
		money = ESX.Math.Round(money)
		TriggerEvent('lorraxs:money', '[Add Money]'..self.name..' '..money)
		if money >= 0 then
	...
	self.removeMoney = function(money)
		money = ESX.Math.Round(money)
		TriggerEvent('lorraxs:money', '[Remove Money]'..self.name..' '..money)
		if money >= 0 then
	...
	self.addBank = function(money)
		money = ESX.Math.Round(money)
		TriggerEvent('lorraxs:money', '[Add Bank]'..self.name..' '..money)
		if money >= 0 then
	...
	self.removeBank = function(money)
		money = ESX.Math.Round(money)
		TriggerEvent('lorraxs:money', '[Remove Bank]'..self.name..' '..money)
		if money >= 0 then
	...
	self.addAccountMoney = function(acc, money)
		...
		TriggerEvent('lorraxs:money', '[Add Account '..acc..']'..self.name..' '..money)
		TriggerClientEvent('esx:setAccountMoney', self.source, account)
	end
	...
	self.removeAccountMoney = function(a, m)
		...
		TriggerEvent('lorraxs:money', '[Remove Account '..a..']'..self.name..' '..m)
		TriggerClientEvent('esx:setAccountMoney', self.source, account)
	end
