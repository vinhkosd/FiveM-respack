...
function TeleportPlayer(pos)
	...
	if #Values["goal"] > 1 then
		...
		function(data, menu)
			...
			if action == "Phòng giam" or action == "Security" then
...
Citizen.Wait(10000)
	local blip = AddBlipForCoord(Config.Teleports["Phòng giam"]["x"], Config.Teleports["Phòng giam"]["y"], Config.Teleports["Phòng giam"]["z"])
    ...
    AddTextComponentString('Nhà Tù Quốc Gia')
