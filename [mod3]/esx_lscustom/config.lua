...
Config.Menus = {
	...
	modTransmission = {
		...
		parent = 'upgrades',
		modType = 13,
		price = {13.95, 20.93, 40.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {3.72, 7.44, 14.88, 29.77, 38.2}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {65.77, 70.28, 75.00, 85.00, 95.00, 100.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
