...
Config.BlowjobPrice			= 5000  	-- Change price for blowjob here
Config.SexPrice				= 10000  	-- Change price for sex here
Config.SocietyNightclub		= True -- Set to true if you want the money players pay to go into the nightclub society account
